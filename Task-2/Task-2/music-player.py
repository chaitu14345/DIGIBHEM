...
def addsongs():
    ...
    for s in temp_song:
        str=s.replace(r"C:\Users\Chaitanya\Music player","")
...
def Play(self):
    ...
    song=r"C:\Users\Chaitanya\Music player"
    mixer.init()
...
def Previous():
    ...
    temp2=r'C:\Users\Chaitanya\Music player\song\{temp2}'
...
def Next():
    ...
    temp=r'C:\Users\Chaitanya\Music player\song\{temp}'
